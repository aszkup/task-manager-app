package com.example.taskmanagerapp.repository.worker
...
import com.example.taskmanagerapp.TaskManagerApplication
...
import com.example.taskmanagerapp.utils.WorkManagerUtils.Companion.WORK_REQUEST_TAG
...
class UploadFileWorker(
    ...
    override val kodein by lazy { (applicationContext as TaskManagerApplication).kodein }
    ...
    companion object {
        const val DROP_BOX_DESTINATION = "/TaskManager Files/"
