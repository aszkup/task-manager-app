...
import com.example.taskmanagerapp.repository.notification.NotificationHelper.Companion.TASK_ID
import com.example.taskmanagerapp.repository.notification.NotificationHelper.Companion.TASK_NAME
...
class NotificationReceiver : BroadcastReceiver(), KodeinAware {
    ...
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        kodein = (context.applicationContext as TaskManagerApplication).kodein
        intent?.let {
            when (intent.action) {
